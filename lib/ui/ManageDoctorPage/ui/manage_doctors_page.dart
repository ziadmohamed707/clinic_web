...
class _ManageDoctorsPageState extends State<ManageDoctorsPage> {
  ...
  void _showAddDoctorDialog({Map<String, dynamic>? doctorToEdit}) {
    ...
    if (isEditing) {
      nameController.text = doctorToEdit['name'] as String;
      selectedDays = List<String>.from(doctorToEdit['availableDays'] as List);
    } else {
              ...
              : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final String doctorName =
                      doctor['name'] as String? ?? 'Unnamed Doctor';
                  final List<String> availableDays = List<String>.from(
                    doctor['availableDays'] as List? ?? [],
                  );
                      ...
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed:
                                () =>
                                    _showAddDoctorDialog(doctorToEdit: doctor),
                            tooltip: 'Edit Doctor',
                          ),
                          IconButton(
                            icon: Icon(
                            ...
                            onPressed:
                                () => _deleteDoctor(doctor['id'] as String),
