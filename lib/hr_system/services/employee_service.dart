...
class EmployeeService {
  ...
  /// جلب الموظفين الذين يتبعون مديراً معيناً (subordinates)
  ...
  /// ستريم لجلب الموظفين الذين يتبعون مديراً معيناً (مباشر)
  Stream<List<EmployeeModel>> employeesStreamByManager(String managerId) {
    return _firestore
        .collection(_collectionName)
        .where('managerId', isEqualTo: managerId)
        .snapshots()
