...
class EmployeeModel {
  ...
  EmployeeModel({
    ...
    this.annualLeaveQuota = 15,
    this.sickLeaveQuota = 7,
  ...
  EmployeeModel copyWith({
    ...
    return EmployeeModel(
      ...
      managerId: managerId ?? this.managerId, // ✅ جديد
    );
  }
}